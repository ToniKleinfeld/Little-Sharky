...
function setEasyLevel() {
    level1 = new level(
        ...
        [   
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L2.png', -720 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L1.png', 0 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L2.png', 720 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L1.png', 720*2 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L2.png', 720*3 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L1.png', 720*4 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L2.png', 720*5 ,0),    
        ],
        [
            new Coin(900,50),
            new Coin(970,20),
