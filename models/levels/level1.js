...
function setHardLevel() {
    level1 = new level(
        ...
        [   
            ...
            new Backgroundfloor('img/3. Background/Layers/2. Floor/D2.png', 719 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/D1.png', 719*2 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/D2.png', 719*3 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/D1.png', 719*4 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/D2.png', 719*5 ,0),    
        ],
        [
            new Coin(900,50),
            new Coin(970,20),
...
function setEasyLevel() {
    level1 = new level(
        ...
        [   
            new BackgroundObject('img/3. Background/Layers/5. Water/L2.png', -719 ,0),
            ...
            new BackgroundObject('img/3. Background/Layers/5. Water/L2.png', 719*3 ,0),
            new BackgroundObject('img/3. Background/Layers/5. Water/L1.png', 719*4 ,0),
            new BackgroundObject('img/3. Background/Layers/5. Water/L2.png', 719*5 ,0),

            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/L2.png', -719 ,0),
            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/L1.png', 0 ,0), 
            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/L2.png', 719 ,0),
            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/L1.png', 719*2 ,0),
            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/L2.png', 719*3 ,0),
            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/L1.png', 719*4 ,0),
            new BackgroundObject('img/3. Background/Layers/4.Fondo 2/L2.png', 719*5 ,0),

            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L2.png', -719 ,0), 
            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L1.png', 0 ,0),
            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L2.png', 719 ,0),
            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L1.png', 719*2 ,0),  
            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L2.png', 719*3 ,0),
            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L1.png', 719*4 , 0),    
            new BackgroundObject('img/3. Background/Layers/3.Fondo 1/L2.png', 719*5 ,0),
        ],
        [
            new Light('img/3. Background/Layers/1. Light/1.png',920 ,0),
            new Light('img/3. Background/Layers/1. Light/2.png',2360,0),
        ...
        [   
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L2.png', -719 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L1.png', 0 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L2.png', 719 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L1.png', 719*2 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L2.png', 719*3 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L1.png', 719*4 ,0),
            new Backgroundfloor('img/3. Background/Layers/2. Floor/L2.png', 719*5 ,0),    
        ],
        [
            new Coin(900,50),
            new Coin(970,20),
